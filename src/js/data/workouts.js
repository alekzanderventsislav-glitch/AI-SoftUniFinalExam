...
export const WORKOUT_GOALS = [
  ...
  { id: 'flexibility', label: 'Гъвкавост' },
];
...
export const workouts = [
  ...
  { id: 'w3', title: 'Сила за горна част', difficulty: 'intermediate', goal: 'muscle-gain', duration: 40, calories: 280, description: 'Тренировка за гърди, рамене и трицепс с собствено тегло.', image: 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=600&h=400&fit=crop', exercises: [{ name: 'Лицеви опори', duration: '4 x 12' }, { name: 'Diamond Push-ups', duration: '3 x 10' }, { name: 'Pike Push-ups', duration: '3 x 10' }, { name: 'Tricep Dips (стол)', duration: '3 x 12' }, { name: 'Plank to Downward Dog', duration: '3 x 10' }, { name: 'Разтягане', duration: '5 мин' }] },
  ...
  { id: 'w5', title: 'Кардио издръжливост', difficulty: 'intermediate', goal: 'endurance', duration: 35, calories: 300, description: 'Продължителна кардио сесия за подобряване на издръжливостта.', image: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=600&h=400&fit=crop', exercises: [{ name: 'Бързо ходене / лек джог', duration: '10 мин' }, { name: 'Скачане на въже', duration: '5 x 2 мин' }, { name: 'High Knees', duration: '4 x 1 мин' }, { name: 'Butt Kicks', duration: '4 x 1 мин' }, { name: 'Side Shuffles', duration: '3 x 1 мин' }, { name: 'Охлаждане', duration: '5 мин' }] },
  { id: 'w6', title: 'Йога за гъвкавост', difficulty: 'beginner', goal: 'flexibility', duration: 30, calories: 120, description: 'Спокойна йога сесия за гъвкавост и възстановяване.', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=400&fit=crop', exercises: [{ name: 'Cat-Cow Stretch', duration: '2 мин' }, { name: 'Downward Dog', duration: '3 x 30 сек' }, { name: 'Warrior I & II', duration: '3 x 30 сек на страна' }, { name: "Child's Pose", duration: '2 мин' }, { name: 'Pigeon Pose', duration: '2 x 1 мин на страна' }, { name: 'Savasana', duration: '5 мин' }] },
  ...
  { id: 'w8', title: 'Core & стабилност', difficulty: 'beginner', goal: 'muscle-gain', duration: 20, calories: 150, description: 'Фокус върху коремните мускули и стабилност на тялото.', image: 'https://images.unsplash.com/photo-1571019613454-1cb75f6bddd3?w=600&h=400&fit=crop', exercises: [{ name: 'Dead Bug', duration: '3 x 10' }, { name: 'Bicycle Crunches', duration: '3 x 15' }, { name: 'Plank', duration: '3 x 40 сек' }, { name: 'Side Plank', duration: '2 x 30 сек на страна' }, { name: 'Leg Raises', duration: '3 x 12' }, { name: 'Разтягане', duration: '3 мин' }] },
  { id: 'w9', title: 'Пилатес за баланс', difficulty: 'intermediate', goal: 'flexibility', duration: 35, calories: 200, description: 'Пилатес програма за по-добър баланс, стойка и контрол върху тялото.', image: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=600&h=400&fit=crop', exercises: [{ name: 'The Hundred', duration: '2 мин' }, { name: 'Roll Up', duration: '3 x 8' }, { name: 'Single Leg Stretch', duration: '3 x 10 на страна' }, { name: 'Spine Stretch Forward', duration: '3 x 10' }, { name: 'Swimming', duration: '3 x 20 сек' }, { name: 'Охлаждане', duration: '5 мин' }] },
];
